...
fun MyProfileScreen() {
    ...
    Column(
        ...
        val image = painterResource(id = R.drawable.biblioteca)
        Box(
        ){
            Image(
                painter = image,
        ...
        Box(
            ...
            Text(
                text = "Davis Alejandro Roldan Ordonez",
                fontWeight = FontWeight.Bold,
                color = Color.Black,
                fontSize = 20.sp,
...
fun Sidebar(){
    Column(
        ...
        SidebarItem(icon = Icons.Default.DateRange, text = "My Calendar", Color (7, 59, 76)) {
            // Handle Settings item click
        }

        SidebarItem(icon = Icons.Default.Check, text = "My Grades", Color(114, 9, 183)) {
            // Handle Settings item click
        }

        SidebarItem(icon = Icons.Default.AccountBox, text = "My Groups", Color(128, 237, 153)) {
            // Handle Settings item click
        }
